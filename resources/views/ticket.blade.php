...
<div class="ticket-area">
    ...
    <div class="ticket-content">
        ...
        <div class="full-width" style="margin-top: 150px">
...
<center> <div style="padding-top:50px;"><h4 class="bordered-text text-center text-white">Invitation Letter</h4></div></center>
...
<div style="padding-top:50px;"> <h4 class="bordered-text-rul text-white"> Detailed rules</h4></div>

 <div style="padding-top:50px;">
 
 <ul class="rule">
     <li><p class="text-white">
     1. It is mandatory for the college students or their accompanying guests to carry the registration card for three days of the event.
           No entry to the venue or collection of food is permitted without registration card.
         </p></li>
     <li><p class="text-white">2. All invited students and guests are requested to keep their registration card visible at all times to ensure security.
     ...
     <li><p class="text-white">4. The registration card must also be presented in case of collection of gift items from the booth mentioned in the card. </p></li>
