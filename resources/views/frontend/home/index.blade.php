            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="title-areas">
                      ...
                      <img class="w-100" style="padding: 0px 0 0px 0px; left: -12px;position: relative;" src="frontend/img/3rd-colum.png"/>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-4">
                            <img style="height:162px;" src="/frontend/img/photo-archive-2.jpg" class="w-100" alt="blog"/>
                        </div>
                        <div class="col-md-4">
                            <img style="height:218px;" src="/frontend/img/photo-archive-4.jpg" class="w-100" alt="blog"/>
                        </div>
                        <div class="col-md-4">
                            <img style="height:218px;" src="/frontend/img/photo-archive-6.jpg" class="w-100" alt="blog"/>
                        </div>
                        <div class="col-md-4">
                            <img style="height:190px; margin-top:-45px" src="/frontend/img/photo-archive-3.jpg" class="w-100" alt="blog"/>
                        </div>
                        <div class="col-md-4">
                            <img style="height:135px;margin-top: 15px;" src="/frontend/img/photo-archive-5.jpg" class="w-100" alt="blog"/>
                        </div>
                        <div class="col-md-4">
                            <img style="height:135px;margin-top: 15px;" src="/frontend/img/photo-archive-7.jpg" class="w-100" alt="blog"/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 sharoklipi">
                    ...
                    <p>কলেজের প্রাক্তন শিক্ষার্থীদের অভিজ্ঞতা ও স্মরণীয় মুহুর্তগুলোকে</br> একত্রিত করে আমরা তৈরি করছি একটি 
                    স্মরণিকা, যা আমাদের
                ...
                <div class="col-md-6">
                    <div class="container">
                        <form>
                            ...
                            <div class="input-group row">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="name" placeholder="ইমেইল"/>
                                </div>
                            </div>
                            <div class="input-group row">
                                <div class="col-sm-12">
                ...
                <div class="col-md-6">
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-body">
                                <p>কলেজ শিক্ষার্থী বা তাদের সাথে আগত অতিথিদের অনুষ্ঠানের তিনদিন আমন্ত্রণপত্র সাথে রাখা বাধ্যতামূলক। আমন্ত্রণপত্র ব্যতীত কোনোভাবেই ভেন্যুতে প্রবেশ এবং খাবার সংগ্রহ করা যাবে না। তাছাড়া নিরাপত্তা নিশ্চিত করার সুবিধার্থে আমন্ত্রিত সকল শিক্ষার্থী এবং অতিথিদের আমন্ত্রণপত্র সর্বদা দৃশ্যমান রাখতে অনুরোধ করা যাচ্ছে। ভলান্টিয়ারগণ যেকোনো মুহূর্তে আমন্ত্রণপত্র চেক করতে পারেন।</P>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                 <div class="accordion-body">
                              <p>  অনলাইন পোর্টালে রেজিস্ট্রেশনের সময় শিক্ষার্থীদের কলেজ থেকে সর্বশেষ অংশগ্রহণকৃত পরীক্ষার রেজিস্ট্রেশন নম্বর প্রয়োজন হবে।
</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                 <div class="accordion-body">
                               <p> ১২ বছর বা তদূর্ধ্ব বাচ্চাদের জন্য আলাদাভাবে রেজিস্ট্রেশন করতে হবে। ১২ বছরের কমবয়সী বাচ্চাদের জন্য অর্ধেক ফি দিয়ে রেজিস্ট্রেশন করতে হবে। ০-২ বছর বয়সী বাচ্চার কোন রেজিস্ট্রেশনের প্রয়োজন নেই।
</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body">
                                <p>পুনর্মিলনী অনুষ্ঠানের উপহার অনুষ্ঠানের দিন ভেন্যু থেকে সংগ্রহ করতে পারবেন। তাছাড়া চাইলে অনুষ্ঠানের আগেও কুরিয়ারের মাধ্যমে আপনার ঠিকানা থেকে সংগ্রহ করতে পারবেন।
</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
                                ...
                                <div class="accordion-body">
                               <p> হ্যাঁ, আপনি চাইলেই আমাদের অনলাইন পোর্টালের মাধ্যমে দেশের বাইরে থেকেও রেজিস্ট্রেশন করতে পারবেন।
                       ...
                       <h2 class="accordion-header" id="headingFive">
                           <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse show" aria-labelledby="headingFive"
                                 data-bs-parent="#accordionExamples">
                                <div class="accordion-body">
                                <p>আমন্ত্রণপত্রই অনুষ্ঠানের ফুড কুপন হিসেবে বিবেচিত হবে। প্রতিবার খাবার সংগ্রহের সময় আমন্ত্রণপত্র প্রদর্শন করতে হবে।
</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                                 data-bs-parent="#accordionExamples">
                                <div class="accordion-body">
                              <p>  বিকাশ, নগদ, রকেট, ইউক্যাশসহ সরাসরি ব্যাংকের মাধ্যমেও পেমেন্ট সম্পন্ন করতে পারবেন।
</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                                 data-bs-parent="#accordionExamples">
                                <div class="accordion-body">
                               <p> পেমেন্ট সম্পন্ন করার পর আমন্ত্রণপত্র আপনার প্রদানকৃত ইমেইল অ্যাড্রেসে পাঠিয়ে দেওয়া হবে। অনুষ্ঠানের দিন আমন্ত্রণপত্রটি প্রিন্ট করে হার্ডকপি সাথে রাখতে হবে। 
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="mapouter">
                    <div class="gmap_canvas">
                        <iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=University of Chandpur Government College, Comilla Rd, Chandpur 3600Oxford&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
