...
<link rel="stylesheet" href="/admin-assets/js/plugins/datatables-buttons-bs5/css/buttons.bootstrap5.min.css">
<link rel="stylesheet" href="/admin-assets/js/plugins/datatables-responsive-bs5/css/responsive.bootstrap5.min.css">
@endonce
@endpush
...
<div class="block block-rounded">
                ...
                <div class="card-body">
                    ...
                    <form action="/all-students" method="get">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type="text" id="name" class="form-control" placeholder="Registration No" name="reg_no">
                            </div>
                            <div class="col-md-3">

                                <input type="text" id="name" class="form-control" placeholder="Mobile Number" name="phone">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" id="name" class="form-control" placeholder="Date" name="date">
    ...
    <div class="block-content block-content-full">
        ...
        <div class="row">
            ...
            <table class="table table-bordered table-striped {{--table-vcenter js-dataTable-buttons dataTable no-footer--}}" {{--id="DataTables_Table_1"--}}>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-w600">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#DetailsModalLong{{$item->id}}">
                                Details
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="DetailsModalLong{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="DetailsModalLongTitle" aria-hidden="true">
                        ...
                        <td class="font-w600">
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#QualificationModalLong{{$item->id}}">
                                Academic
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="QualificationModalLong{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="QualificationModalLongTitle" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                        ...
                        <td class="font-w600">
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#professionModalLong{{$item->id}}">
                                Profession
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="professionModalLong{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="professionModalLongTitle" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                        ...
                        <td class="font-w600">
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#guestModalLong{{$item->id}}">
                                Guest
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="guestModalLong{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="guestModalLongTitle" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                        ...
                        <td class="font-w600">
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#giftModalLong{{$item->id}}">
                                Gift
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="giftModalLong{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="giftModalLongTitle" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
